...
def record_to_query_params(record: DetectionRecord) -> Dict[str, Any]:
    ...
    No OCR runs in this pipeline - the plate crop image is uploaded as the
    "Image" file (see send_detection below) and reading the plate number is
    entirely up to whatever is on the other end of this API call."""
