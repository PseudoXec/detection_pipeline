...
-----------------------------
This project's own README already found NCNN faster than OpenVINO on the
Pi 5's ARM CPU (Ultralytics' own Pi 5 benchmarks agree). This script is the
NCNN equivalent of export_openvino.py.
