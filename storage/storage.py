...
class DetectionStorage:
    ...
    def __init__(
        ...
        # resolved once at startup via ISAPI (camera/isapi_client.py) and reused for
        # every record sent over the pipeline's lifetime - the camera doesn't move or
        # get renamed mid-run, so there's no need to store these per-row
